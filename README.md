...
- 🧪 Technical experiments that become usable products
...
My goal is to develop the technical depth to independently design, build, deploy, and maintain useful software.
...
**AI:** LLM applications, AI-assisted workflows, automation  
**Engineering:** Git, GitHub, testing, CI/CD, documentation
...
I'm working toward meaningful open-source participation through useful contributions, bug fixes, documentation, and developer tooling.
